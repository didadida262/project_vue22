...
-->
<template>
  <el-tooltip class="item" effect="dark" content="粗铅笔" placement="right">
    <div
     :class="[{ 'is-active': selected === 'fat_pencil' }]"
     @click="handleClickTool">
    <svg t="1677311081751" fill="currentColor" class="icon" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2769" width="16" height="16">
